...
module.exports.onStart = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("বস rionto, খানকিরপুলারে একটা মেনশন দেন-!!🫂", event.THREADIDRIONTO);
 let name =  event.mentions[mention];
    var arraytag = [];
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.); }
a("তোরে চুদলো BOSS rionto");
